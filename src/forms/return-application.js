...
const NewApplicant = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:4500/api/client_form/getRequestByReturned', { headers: { "Authorization": `Bearer ${token}` } })
    .then(res => res.json())
    .then(data => {
    ...
    <>
      <div>
        ...
        <div className="cards-containers2">
          ...
          <h4 className="title-appl">Returned Applications</h4>
          {/* 
                      ...
                      <td>
                        <div className="btn-group">
                          ...
                          <div className="dropdown-menu" style={{}}>
                            <a className="dropdown-item" href={`/view-request-details-return?id=${item._id}`}>
                              View Details</a>
                            <a className="dropdown-item" href={`/rapplication?id=${item._id}`} style={{ textDecoration: "none" }}>
                              Applications</a>
