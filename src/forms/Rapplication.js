...
const handleView = () => {
  ...
  .then(res=>{
      console.log("res in application",res.data)
  ...
  <div className="row">
    <div className="col-md-6">
      <div className="card-text" style={{display:"flex", flexDirection: "row", margin:" 4px 80px"}}>
         <p>Names:</p>  <p style={{color:"grey"}}>{details.fullname}</p>  <p >Status:</p> <p style={{paddingRight:"200px",color:"grey"}}>{oneRequest.status}</p>
        </div>
