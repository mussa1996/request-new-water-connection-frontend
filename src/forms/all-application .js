...
const NewApplicant = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:4500/api/client_form/getAll', { headers: { "Authorization": `Bearer ${token}` } })
    .then(res => res.json())
    .then(data => {
      console.log("data", data)
        setRequest(data.pro);
        setFilteredData(data.pro);
    });
}, []);
    ...
    <>
      <div>
        ...
        <div className="cards-containers2">
          ...
          <h4 className="title-appl">New Applications</h4>
          {/* 
                      ...
                      <td>
                        <div className="btn-group">
                          ...
                          <div className="dropdown-menu" style={{}}>
                            <a className="dropdown-item" href={`/view-request-details-dash?id=${item._id}`}>
                              View Details</a>
