...
import "./billing.css"
import DataTableEdit from"../../user-form/validation"
...
console.log("handleSave", handleSave);
  ...
  const handleNo = () => {
    ...
    console.log("data from edit",DataTableEdit)
    console.log("data from edit",DataTableEdit.data)
    return (
            ...
            <table  id="customers">
                ...
                <tbody>
                    <tr style={{border: "1px solid black "}}>
                        <td contentEditable={true}  style={{border: "1px solid black "}} ></td>
                        <td contentEditable={true}  style={{border: "1px solid black "}}> </td>
                        <td  contentEditable={true} style={{border: "1px solid black "}}> </td>
                    </tr>
                    <tr style={{border: "1px solid black "}}>
